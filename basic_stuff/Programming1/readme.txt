...
Try to install locally ('npm install truffle') in case you get permission error (i.e. do not use sudo) in the programming_one folder where you will be working.

Once you have installed Truffle, Create your project:

mkdir programming_one && cd programming_one
truffle init (if you installed locally you can find truffle in ./node_modules/.bin/truffle)
